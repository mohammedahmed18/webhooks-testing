...
from app.unstructured.coordinates import (
...
class ElementMetadata:
    ...
    def from_dict(cls, meta_dict: dict[str, Any]) -> ElementMetadata:
        ...
        """
        from app.unstructured.base import elements_from_base64_gzipped_json
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        `None`.
        """
        from app.unstructured.base import elements_to_base64_gzipped_json
...
def _kvform_rehydrate_internal_elements(kv_pairs: list[dict[str, Any]]) -> list[FormKeyValuePair]:
    ...
    """
    from app.unstructured.base import elements_from_dicts
